      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-4 items-center justify-center mb-6">
          <form
            ...
            className="flex items-center bg-gray-100 rounded px-4 py-2 shadow"
          >
            <input
          ...
          <div className="relative">
            <select
              ...
              className="bg-gray-100 border border-gray-300 rounded px-4 py-2 shadow focus:ring focus:ring-blue-200"
            >
