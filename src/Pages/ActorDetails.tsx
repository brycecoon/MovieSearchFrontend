...
const ActorDetails = () => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 min-h-screen px-6 py-12">
      <div className="min-h-screen bg-gray-800 py-10 rounded-lg">
        <div className="mx-auto px-6 max-w-screen-xl">
          <div className="text-gray-900 bg-gray-200 rounded-lg shadow-lg shadow-gray-500">
            {/* Actor's Details */}
            <div className="p-6">
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="w-full">
                    <img
                      ...
                      alt={actor?.name}
                      className="sm:w-auto md:w-96 lg:w-96 object-cover rounded-lg shadow-xl"
                    />
                  </div>
                  ...
                  <div className="w-full flex justify-center items-center">
                    <div className="w-full max-w-[700px]">
                      ...
                      <p className="text-gray-200 bg-gray-800 rounded-lg p-3 text-lg leading-6 overflow-y-auto sm:max-h-[600px] md:max-h-[500px]">
